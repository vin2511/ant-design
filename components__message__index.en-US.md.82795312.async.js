"use strict";(self.webpackChunkantd=self.webpackChunkantd||[]).push([[6518],{241603:function(m,o,t){t.r(o);var c=t(502143),Z=t(968521),p=t(720719),v=t(28840),a=t(759907),s=t(828089),g=t(902068),h=t(574399),x=t(863942),f=t(316073),E=t(24628),P=t(719260),A=t(956140),u=t(127179),i=t(905388),D=t(51301),M=t(606965),y=t(249706),C=t(795127),B=t(116846),O=t(73024),l=t(606641),d=t(667294),e=t(370917);function _(){var r=(0,l.eL)(),n=r.texts;return(0,e.tZ)(l.dY,null,(0,e.tZ)(d.Fragment,null,(0,e.tZ)("div",{className:"markdown"},(0,e.tZ)("p",null,n[0].value),(0,e.tZ)("h2",{id:"when-to-use"},(0,e.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#when-to-use"},(0,e.tZ)("span",{className:"icon icon-link"})),"When To Use"),(0,e.tZ)("ul",null,(0,e.tZ)("li",null,n[1].value),(0,e.tZ)("li",null,n[2].value)),(0,e.tZ)("h2",{id:"examples"},(0,e.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#examples"},(0,e.tZ)("span",{className:"icon icon-link"})),"Examples")),(0,e.tZ)(i.Z,{items:[{demo:{id:"components-message-demo-hooks"},previewerProps:{title:"Hooks usage (recommended)",filename:"components/message/demo/hooks.tsx",jsx:`import { Button, message } from 'antd';
const App = () => {
